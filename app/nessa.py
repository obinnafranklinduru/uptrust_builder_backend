...
def CvAnalyser(cv_file_name=os.path.abspath(r"C:\Users\USER\uptrust_builder_backend\app\cv_file.pdf"),
               job_file=os.path.abspath(r"C:\Users\USER\uptrust_builder_backend\app\jobs_datascientist.csv")):
